...
module.exports = async function () {
  const erc1400HoldableToken = await ERC1400HoldableToken.new(
  ...
  const tokenInstance = await ERC1400HoldableToken.new(
    'ERC1400HoldableToken',
    'DAU',
    1,
    [controller],
  ...
  const tokenInstance2 = await ERC1400HoldableToken.new(
    'ERC1400HoldableToken',
    'DAU',
    1,
    [controller],
