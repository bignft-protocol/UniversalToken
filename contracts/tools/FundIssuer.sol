    ...
    ERC1820Implementer
{
    ...
    bytes32 internal constant ORDER_SUBSCRIPTION_FLAG =
        0xcccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc;
    bytes32 internal constant ORDER_PAYMENT_FLAG =
    ...
    function _executePayment(
        ...
        if (!bypassPayment) {
            if (cycle.paymentType == Payment.ETH) {
                ...
                _escrowedErc20[cycle.assetAddress][
                ...
                _escrowedErc1400[cycle.assetAddress][cycle.paymentAddress][
                    cycle.paymentPartition
                ] += value;
            } else if (
                cycle.paymentType == Payment.ERC1400 &&
