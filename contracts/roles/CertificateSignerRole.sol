...
abstract contract CertificateSignerRole {
    ...
    event CertificateSignerAdded(
        address indexed token,
        address indexed account
    );
    event CertificateSignerRemoved(
        address indexed token,
        address indexed account
    );
    ...
    function isCertificateSigner(address token, address account)
        public
        view
        returns (bool)
    {
    ...
    function addCertificateSigner(address token, address account)
        public
        onlyCertificateSigner(token)
    {
        _addCertificateSigner(token, account);
    }

    function removeCertificateSigner(address token, address account)
        public
        onlyCertificateSigner(token)
    {
